                    ...
                    <li className="flex justify-between gap-x-1 py-1">
                        <div className="flex min-w-0">
                            ...
                            <div className="min-w-0 flex-auto">
                                <p className="text-sm font-semibold leading-6 text-gray-900">{fisioterapeuta.name}</p>
                                <p className="mt-1 truncate text-xs leading-5 text-gray-500">{fisioterapeuta.specialty}</p>
                            </div>
                        </div>
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            <p className="text-sm leading-6 text-gray-900">Lesão de Joelho</p>
                            <p className="mt-1 text-xs leading-5 text-gray-500">Última Sessão <time datetime="2023-01-23T13:23Z">há 2 dias</time></p>
                        </div>
                    </li>
                </ul>
            </div>
