...
export default function CadastradoPaciente() {
    ...
    useEffect(() => { 
            axios.get(endpoint_physiotherapist)
            .then(function (response) {  
          ...
          <form onSubmit={novoPaciente}>
            <div className="grid gap-10 mb-10 md:grid-cols-2">
              ...
              <label
                ...
                >{ listaFisioterapeutas.map((fisioterapeuta) => <option value={fisioterapeuta.id}>{fisioterapeuta.name}</option>) }
                </select>
              </div>
              <br/>
              <div>
              ...
              <label
                ...
                >{ listatreatment.map((tratamento) => <option value={tratamento.id}>{tratamento.name}</option>) }
                </select>
              </div>
              <br/>
              <div>
